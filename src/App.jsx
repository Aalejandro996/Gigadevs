            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white text-gray-900 p-8 rounded-3xl shadow-2xl flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-gray-500 mb-6 text-sm">Solución integral para la gestión empresarial</p>
                  ...
                  <ul className="space-y-3 mb-8 text-sm text-gray-700">
                    <li className="flex items-center"><CheckCircle size={16} className="text-green-500 mr-2 flex-shrink-0" /> Sistema Personalizado</li>
                    <li className="flex items-center"><CheckCircle size={16} className="text-green-500 mr-2 flex-shrink-0" /> Pagina Web</li>
                    <li className="flex items-center"><CheckCircle size={16} className="text-green-500 mr-2 flex-shrink-0" /> App Movil o De Escritorio</li>
                  </ul>
                </div>
              ...
              <div className="bg-white text-gray-900 p-8 rounded-3xl shadow-2xl flex flex-col justify-between">
                ...
                <button onClick={() => handleOpenModal('Página Web / E-commerce', 250, 'único')} className="w-full py-3 bg-blue-950 text-white font-bold rounded-xl hover:bg-blue-900 transition text-xs shadow">
                  Comprar Licencia Vitalicia ($250)
                </button>
              </div>
              ...
              <div className="bg-gradient-to-b from-yellow-400 to-amber-500 text-blue-950 p-8 rounded-3xl shadow-2xl flex flex-col justify-between relative transform lg:-translate-y-2">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-black text-blue-950 mb-2">Totalmente Personalizado</h3>
                  <p className="text-blue-950/80 mb-6 text-sm font-medium">Software con base de datos blindada para tu empresa.</p>
                  <div className="flex items-baseline mb-6">
                    <span className="text-4xl font-black text-blue-950">$300</span>
                ...
                <button onClick={() => handleOpenModal('Sistema a Medida', 300, 'único')} className="w-full py-3 bg-blue-950 text-white font-extrabold rounded-xl hover:bg-blue-900 transition text-xs shadow-xl">
                  Solicitar Sistema Vitalicio ($300)
                </button>
              </div>
